            ...
            >
              ...
              {editingId === project.id ? (
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    type="text"
                    className="w-full bg-black/50 border border-blue-500/50 rounded px-2 py-1 text-xs text-gray-300 focus:outline-none"
                  ...
                  <textarea
                    ...
                    className="w-full bg-black/50 border border-blue-500/50 rounded px-2 py-1 text-xs text-white focus:outline-none resize-none"
                  ...
                  <div className="grid grid-cols-12 gap-2 items-center text-xs w-full">
                    ...
                    <div className="col-span-3 flex justify-end items-center gap-1">
                      ...
                      <button
                        ...
                        className="opacity-0 group-hover:opacity-100 text-gray-500 hover:text-blue-400 hover:bg-blue-500/10 p-1 rounded transition-all"
                        title="Edit Project"
                      >
                        ✏️
                      </button>
